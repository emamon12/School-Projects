...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int x = 0; x < alignTitles.length; x++) {
            System.out.printf("%11s", alignTitles[x].substring(1, 9));
        }
        System.out.println();

        for (int x = 0; x < numSpecies; x++) {
            for (int y = 0; y < numSpecies; y++) {
                System.out.printf("%11.5f", distValues[x][y]);
            }
            System.out.println();
        }
        ...
        for (int x = 0; x < alignTitles.length; x++) {
            alignTitles[x] = alignTitles[x].substring(1, 11);
        }

        System.out.println("K Values: ");
        for (int x = 0; x < alignTitles.length; x++) {
            System.out.printf("%11s", alignTitles[x].substring(0, 8));
        }
        System.out.println();

        for (int x = 0; x < numSpecies; x++) {
            for (int y = 0; y < numSpecies; y++) {
                System.out.printf("%11.5f", kValues[x][y]);
            }
            System.out.println();
        }
        ...
        FindShortestPairWiseDist up = new FindShortestPairWiseDist();

        up.findDist(kValues, alignTitles);
