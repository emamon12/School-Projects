...
```{r} 
# start your code
#X is normally distributed with a slight skew to the right
plotDist('binom', size=40, prob=.75)
dbinom(x=30, size=40, prob=.75)
pbinom(q=30, size=40, prob=.75)#dbinom only tallies when x is equal to 30, where pbinom tallies whenever x<30
pbinom(q=35, size=40, prob=.75) - pbinom(q=30, size=40, prob=.75)
# last R code line
```
...
rnorm(n=50,mean=26.4,sd=4.2)
pnorm(q=23.5,mean=26.4,sd=4.2)#24.49474%
1-pnorm(q=32.5,mean=26.4,sd=4.2)#7.319785%
pnorm(q=29,mean=26.4,sd=4.2)-pnorm(q=24,mean=26.4,sd=4.2)#44.82029%
qnorm(p=0.25,mean=26.4,sd=4.2)#23.56714mm
